...
public class Camry extends LightCar {
    ...
    public Camry(ModelGuide modelGuide, Country country, String color, double maxSpeed, Transmission transmission,
        ...
        super(modelGuide, country, color, maxSpeed, transmission, wheel, gasTank, engine, electrician,
